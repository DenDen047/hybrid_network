...
class baseline_snn(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        snn4_states = self.snn4.create_init_states()
        ...
        flatten_spike_l3 = torch.flatten(spike_l3, start_dim=1, end_dim=-2)

        axon4_out, axon4_states = self.axon4(flatten_spike_l3, axon4_states)
        spike_l4, snn4_states = self.snn4(axon4_out, snn4_states)
